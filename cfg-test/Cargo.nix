...
rec {
  ...
  rootCrate = {
    packageId = "cfg-test 0.1.0 (path+file:///home/andi/dev/private/crate2nix-issues/cfg-test)";
  ...
  crates = {
    ...
    "cfg-test 0.1.0 (path+file:///home/andi/dev/private/crate2nix-issues/cfg-test)"
      = rec {
        crateName = "cfg-test";
        version = "0.1.0";
        edition = "2018";
